...
1. You need CMake 3.10 or newer to build QmidiNet

2. Unpack the QmidiNet sources somewhere, or checkout the repository, 
   and create a build directory. For instance, using a command line shell:
   
$ tar -xvzf Downloads/qmidinet-x.y.z.tar.gz
$ cd qmidinet-x.y.z
$ mkdir build
...
The CMake build system for QmidiNet is experimental. It will take a while
until it becomes stable and fully tested. You can help providing feedback, 
please send a report containing your problems to the QmidiNet development 
mailing list, https://lists.sourceforge.net/mailman/listinfo/qmidinet-devel
